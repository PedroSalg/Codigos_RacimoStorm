...
#define BS_IOPINS1_7_VAL ((const uint8 CYFAR *)0x480000F8u)
...
#define BS_IOPINS0_2_VAL ((const uint8 CYFAR *)0x48000108u)
...
static void AnalogSetDefault(void)
{
	...
	CY_SET_XTND_REG8((void CYFAR *)CYREG_PRT2_AG, 0x49u);
