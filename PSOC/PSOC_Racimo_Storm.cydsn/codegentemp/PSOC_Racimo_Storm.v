// ======================================================================
// PSOC_Racimo_Storm.v generated from TopDesign.cysch
// 12/09/2019 at 15:22
...
// Mixer_v2_0(LO_clock_freq=4, LO_Source=1, Mixer_Type=0, Power=3, Signal_Frequency=0.3, Vdda_Value=5, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=Mixer_v2_0, CY_CONFIG_TITLE=Mixer, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Mixer, CY_INSTANCE_SHORT_NAME=Mixer, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=Mixer, )
module Mixer_v2_0_0 (
    Fin,
    Fout,
    LO,
...
module top ;
	...
	wire [1:0] tmpOE__Pin_net;
	wire [1:0] tmpFB_1__Pin_net;
	...
	assign tmpOE__Pin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{2'b11} : {2'b11};
	...
	wire [0:0] tmpOE__VDC_net;
	wire [0:0] tmpFB_0__VDC_net;
	wire [0:0] tmpIO_0__VDC_net;
	wire [0:0] tmpINTERRUPT_0__VDC_net;
	electrical [0:0] tmpSIOVREF__VDC_net;
	...
	cy_psoc3_pins_v1_10
		...
		VDC
		 (.oe(tmpOE__VDC_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__VDC_net[0:0]}),
		  .analog({Net_21}),
		  .io({tmpIO_0__VDC_net[0:0]}),
		  .siovref(tmpSIOVREF__VDC_net),
		  .interrupt({tmpINTERRUPT_0__VDC_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__VDC_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
