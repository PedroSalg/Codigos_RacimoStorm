...
#endif
static const char *ng0 = "/home/pedro/Documents/ISE/Escritura_Borrado_Lectura/Esc_Lec_Bor_Toda_La_Memoria/CNT2S.vhd";
...
LAB3:    t2 = ieee_p_3499444699_sub_17544701978858283880_3536714472(IEEE_P_3499444699, t1, 500, 26);
    t3 = (26U != 26U);
    if (t3 == 1)
        goto LAB5;
...
LAB5:    xsi_size_not_matching(26U, 26U, 0);
    goto LAB6;
...
LAB4:
LAB7:    t17 = xsi_get_transient_memory(26U);
    memset(t17, 0, 26U);
    t18 = t17;
    memset(t18, (unsigned char)2, 26U);
    t19 = (t0 + 5096);
    t20 = (t19 + 56U);
    t21 = *((char **)t20);
    t22 = (t21 + 56U);
...
LAB5:    xsi_size_not_matching(26U, t10, 0);
    goto LAB6;
